...
export default function Auth({side}: AuthProps) {
    ...
    useEffect(() => {
        ...
        getBrowserInfoWithHash().then(
            (hash) => setFingerPrint(hash)
        ).catch(
            (e) => console.error("get fingerprint error: ", e)
        )
        ...
        <div style={styles.authHalf}>
            ...
            <div style={styles.authForm}>
                <div style={styles.inputGroup}>
                    <label style={styles.label} htmlFor={`alias-${side}`}>別名</label>
                    <input
                        id={`alias-${side}`}
                        style={styles.input}
                        type="text"
                ...
                <div style={styles.inputGroup}>
                    <label style={styles.label} htmlFor={`pin-${side}`}>PIN碼</label>
                    <input
                        id={`pin-${side}`}
                        style={styles.input}
                        type="password"
                ...
                <div style={styles.inputGroup}>
                    <label style={styles.label} htmlFor={`password-${side}`}>密碼</label>
                    <input
                        id={`password-${side}`}
                        style={styles.input}
                        type="password"
                ...
                <div style={styles.inputGroup}>
                    <label style={styles.label} htmlFor={`ip-${side}`}>IP地址</label>
                    <input
                        id={`ip-${side}`}
                        style={styles.input}
                        type="text"
                ...
                <div style={styles.inputGroup}>
                    <label style={styles.label} htmlFor={`fingerPrint-${side}`}>指紋</label>
                    <input
                        id={`fingerPrint-${side}`}
                        style={styles.input}
                        type="text"
