...
export const generateNewAid = async (): Promise<Aid> => {
    ...
    let contractAddress = prompt("Please enter the aid contract address")
    ...
    newAid.addCert({
        BlockChainUrl: "http://127.0.0.1:8080/", ContractAddress: contractAddress, ServerAddress: "http://localhost:8080",
        Sign: "",
        Aid: uuid,
        CertType: AidType.Blockchain,
        Claims: {},
        Setting: {},
        VerifyOptions: {
